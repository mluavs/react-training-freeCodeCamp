...
//useState retorna sempre dois valores, o estado atual e uma função que atualiza esse estado 

//ele avisa que essa função vai totalmente contra o princípio de dry code e reforça que na vida real ele nunca escreveria código assim
